...
set -x
        ...
        do
			...
			cp $rc slave.$machine
                        ...
                        srun -p $partition --nodelist $machine -N1 -n12 --exclusive ./slave.$machine slave $ipAdd $portNo +RTS -l-au -N12 & 
                	sleep 2
	...
	cp $rc master.$getMasterIP	
        srun -p $partition --nodelist $getMasterIP -N1 -n12 --exclusive ./master.$getMasterIP master $ipAdd $portNo +RTS -l-au -N12
